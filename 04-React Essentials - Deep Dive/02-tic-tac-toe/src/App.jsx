...
import GameBoarde from "./components/Gameboard";
...
function App() {
  ...
  function handleSelectSquare(rowIndex, coldIndex) {
    // setActivePlayer((prev) => (prev == "X" ? "O" : "X"));
    setGameTurns((prev) => {
      const currentPlayer = deriveActivePlayer(prev);

      const updatedTurns = [
        { square: { row: rowIndex, col: coldIndex }, player: currentPlayer },
        ...prev,
      ];
  ...
  return (
    <main>
      <div id="game-container">
        ...
        <GameBoarde onSelectSquare={handleSelectSquare} board={gameBoard} />
      </div>
      <Log turns={gameTurns} />
    </main>
  );
